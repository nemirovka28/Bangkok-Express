...
import slides from './src/js/slides.js';

import RibbonMenu from './src/js/ribbonMenu.js';
import categories from './src/js/categories.js';

import StepSlider from './src/js/stepSlider.js';
import ProductsGrid from './src/js/productsGrid.js';

import CartIcon from './src/js/cartIcon.js';
